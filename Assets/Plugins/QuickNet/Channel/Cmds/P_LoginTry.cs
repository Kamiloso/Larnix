...
{
    public class P_LoginTry : Payload
    {
        private const int SIZE = 32 + 64 + 64 + 8 + 8 + 8;
        ...
        public P_LoginTry() { }
        public P_LoginTry(string nickname, string password, long serverSecret, long challengeID, long timestamp, string newPassword = null, byte code = 0)
        {

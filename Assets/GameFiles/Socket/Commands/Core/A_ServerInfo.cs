...
namespace Larnix.Socket.Commands
{
    public class A_ServerInfo : BaseCommand
    {
            ...
            : base(packet)
        {
            ...
            UserText1 = Common.FixedBinaryToString(bytes[288..544]);
            UserText2 = Common.FixedBinaryToString(bytes[544..800]);
            UserText3 = Common.FixedBinaryToString(bytes[800..1056]);
        ...
        public override Packet GetPacket()
        {
            byte[] bytes = ArrayUtils.MegaConcat(
                ...
                Common.StringToFixedBinary(UserText1, 128),
                Common.StringToFixedBinary(UserText2, 128),
                Common.StringToFixedBinary(UserText3, 128)
                );
        ...
        protected override void DetectDataProblems()
        {
            bool ok = (
                ...
                Common.IsGoodUserText(UserText1) &&
                Common.IsGoodUserText(UserText2) &&
                Common.IsGoodUserText(UserText3)
                );

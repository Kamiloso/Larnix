...
namespace Larnix.Socket.Frontend
{
    ...
    public static class Resolver
    {
        ...
        public static Task<A_ServerInfo> DownloadServerInfoAsync(string address, string authcode, string nickname)
        {
            return Task.Run(() =>
            {
                return _DownloadServerInfo(address, authcode, nickname, true);
            });
        }
        ...
        public static Task<EntryTicket> GetEntryTicketAsync(string address, string authcode, string nickname)
        {
            return Task.Run(() =>
            {
                A_ServerInfo info = _DownloadServerInfo(address, authcode, nickname);
        ...
        private static A_LoginTry _TryLoginWrap(string address, string authcode, string nickname, string password, bool isRegistration, string optionalNewPassword = null)
        {
            ...
            long timestamp = Timestamp.GetServerTimestamp(ResolveString(address));

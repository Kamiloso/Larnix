...
namespace Larnix.Socket.Backend
{
    public class Server : IDisposable
    {
        ...
        public Server(ushort port, ushort maxClients, bool isLoopback, string dataPath, uint gameVersion,
            string userText1 = "",
            string userText2 = "",
            string userText3 = ""
            )
        {
            if (!Common.IsGoodUserText(userText1) || !Common.IsGoodUserText(userText2) || !Common.IsGoodUserText(userText3))
                throw new ArgumentException("Wrong UserText format! Cannot be larger than 128 characters or contain NULL (0x00).");
            ...
            FastMessages = new ManagerNCN(this, dataPath);
            ...
            Authcode = Data.Authcode.ProduceAuthCodeRSA(KeyObtainer.KeyToPublicBytes(KeyRSA), Secret);

...
namespace Larnix.Server.Worldgen
{
    ...
    public class Generator
    {
        ...
        // Data structures
        private static readonly Dictionary<BiomeID, Biome> Biomes = Biome.CreateBiomeInstances();
        ...
        public BlockData[,] GenerateChunk(Vector2Int chunk)
        {
            ...
            BlockData[,] blocks = ConvertToBlockArray(protoBlocks, chunk);
        ...
        private BlockData[,] ConvertToBlockArray(ProtoBlock[,] protoBlocks, Vector2Int chunk)
        {
